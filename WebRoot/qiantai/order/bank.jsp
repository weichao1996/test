...
<div class="about_top">
 ...
 <input type="hidden" name="orderId" value="<s:property value="#order.orderId"/>"/>
                  ...
                  <table width="100%">
                  	...
                  	<tr>
                  		<td><input type="radio" id="b" name="b"><img src="/book/img/bank1.jpg" width="100" height="60"> </td>
                  		<td><input type="radio" id="b" name="b"><img src="/book/img/bank2.jpg" width="100" height="60"> </td>
                  		<td><input type="radio" id="b" name="b"><img src="/book/img/bank3.jpg" width="100" height="60"> </td>
                  		<td><input type="radio" id="b" name="b"><img src="/book/img/bank4.jpg" width="100" height="60"> </td>
                  		<td><input type="radio" id="b" name="b"><img src="/book/img/bank5.jpg" width="100" height="60"> </td>
                  	</tr>
