...
<div class="about_top">
  <div class="container">
				...
				<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
					<form action="<%=path %>/addToCart.action" method="post" name="buy">
						<table width="100%" border="0">
						    ...
						    <tr>
						       <td align="left">图书名称：<s:property value="#request.goods.goodsName"/><hr/></td>
						        <td align="left">购买价格:<s:property value="#request.goods.goodsTejia"/><hr/></td>
						    </tr>
						    
						    <tr>
						      
						           <td align="left">出版社:<s:property value="#request.goods.publisher"/><hr/></td>
						           	           <td align="left">图书作者:<s:property value="#request.goods.author"/><hr/></td>
						          
						    </tr>
						    	    <tr>
						      
						           <td align="left">ISBN编号:<s:property value="#request.goods.isbn"/><hr/></td>
						           	           <td align="left">出版时间:<s:property value="#request.goods.publishtime"/><hr/></td>
						          
						    </tr>
				
						    <tr>
						       <td align="left">图书介绍:<s:property value="#request.goods.goodsMiaoshu" escape="false"/><hr/></td>
						    </tr>
						    ...
						    <tr>
						       ...
						       <img onclick="buy1()" src="<%=path %>/img/goumai.jpg"/><hr/></td>
						    </tr>
						</table>
						</form>
				</div>
				<s:if test="#session.userType ==2">			<!-- 已登录才可以看评论 -->
				<hr/>
	    ...
	    <s:if test="#request.count>0">	<!-- 该用户购买过该图书 -->
	    <TABLE style="MARGIN-TOP: 8px; WORD-BREAK: break-all" borderColor=#e3e3e3 cellSpacing=0 borderColorDark=white cellPadding=0 rules=all width="99%"  borderColorLight=#e0e0e0 border=1>
	        <TR bgColor=#f0f0f0 height=30>
		          <TD style="TEXT-INDENT: 5px" width="12%" style="font-size: 11px;"></TD>
		          <TD colSpan=2 style="font-size: 11px;">
		                <span style="float:left">对此图书评价 </span>
		          </TD>
	        </TR>
	        <TR bgColor=#f9f9f9>
